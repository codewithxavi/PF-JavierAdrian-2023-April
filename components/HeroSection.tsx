    ...
    <section id="home">
      <div className="flex flex-col items-center  animate-fadeIn animation-delay-2 ">
        <div className="w-5/5 pt-24">
          <h1 className="flex  pb-4 text-5xl font-extrabold text-transparent md:h-24 bg-clip-text bg-gradient-to-r from-purple-800 to-fuchsia-950 dark:from-yellow-300 dark:to-emerald-500 md:text-6xl">Hi, I&apos;m Javi!</h1>
